getNIBirths <- function() {
  NIbirths <- data.frame(
    year <- seq(1997, 2016),
    GBBirths <- c(1756, 1675, 1650, 1550, 1560, 1470, 1430, 1390, 1430, 1470,
      1440, 1400, 1360, 1320, 1300, 1280, 1240, 1180, 1190, 1052),
    EU26Births <- c(176, 172, 174, 176, 183, 179, 186, 183, 205, 600, 1050,
      1380, 1400, 1500, 1480, 1485, 1545, 1605, 1600, 1590),
    IEBirths <- c(723, 780, 650, 620, 700, 640, 645, 660, 665, 672, 681, 710,
      700, 735, 685, 700, 688, 635, 640, 618),
  ...
  ggsave(filename = getwd() %>%
           paste0('/figures/raw/birthBreakdown.png'),
         plot = NIBirthsPlot)
